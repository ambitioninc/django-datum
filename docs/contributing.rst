...
.. _ambitioninc repository: https://github.com/ambitioninc/django-datum/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/ambitioninc/django-datum.git
    $ cd django-datum
    $ virtualenv env
    $ . env/bin/activate
...
.. code-block:: python
    ...
    from datum.version import __version__
...
When in the project directory::
    ...
    $ pip uninstall -y django-datum && python setup.py install
    $ cd docs && make html
...
* Bump version in datum/version.py
